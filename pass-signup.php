...
if(isset($_POST['pass_register'])) {
    ...
    if(empty($_POST['pass_fname'])  || empty($_POST['pass_phone']) || empty($_POST['pass_addr']) || empty($_POST['pass_uname']) || empty($_POST['pass_email']) || empty($_POST['pass_pwd'])) {
        ...
        $query = "INSERT INTO orrs_passenger (pass_fname,  pass_phone, pass_addr, pass_uname, pass_email, pass_pwd) VALUES (?,?,?,?,?,?)";
        $stmt = $mysqli->prepare($query);
        $rc = $stmt->bind_param('ssssss', $pass_fname,  $pass_phone, $pass_addr, $pass_uname, $pass_email, $pass_pwd);
